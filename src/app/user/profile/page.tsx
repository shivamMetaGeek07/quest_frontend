  ...
  return (
    ...
    <div className="min-h-screen">
      <div className="w-[90%] mx-auto">
        <div className="flex flex-col lg:flex-row gap-4 items-center justify-between mt-4 mx-4 lg:mx-10">
          {/* user info */}
              ...
              <div className="w-3/5 flex lg:justify-start justify-center mt-6 lg:mt-1 items-center">
                <div className="flex flex-col justify-between items-center"> 
                  ...
                  <div className="flex flex-row gap-2 my-2 justify-start items-center">
                    <div className="p-2 border-white border-2 rounded-lg text-2xl ">
