        ...
        <section className="mt-20">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="w-2/5 flex flex-col justify-center items-center">
              ...
              <div className="w-3/5 flex lg:justify-start  mt-6 lg:mt-1">
                <div className="flex flex-col justify-between lg:items-start items-center"> 
                  ...
                  <div className="flex row py-4 px-2 ">
                    <div className="box1 right-trapezium w-[2rem] h-[2rem] bg-white">
                    ...
                    <div className="box1 left-right-trapezium w-[2rem] h-[2rem] bg-white" >
                    ...
                    <div className="box1 left-trapezium w-[2rem] h-[2rem] bg-white">
