                  ...
                  <div className="lg:w-[16rem] flex lg:justify-start  mt-6 lg:mt-1">
                    <div className=" flex flex-col lg:items-start items-center gap-[0.75rem]">
                      ...
                      <div className="flex row gap-1">
                        <div onClick={signupX} className="box1 right-trapezium  w-[2rem] h-[2rem] bg-[#ffffff33]">
                        ...
                        <div onClick={signupDiscord} className="box1 left-right-trapezium w-[2rem] h-[2rem] px-2 bg-[#ffffff33]" >
                        ...
                        <div id="telegram-login" className="box1 left-trapezium w-[2rem] h-[2rem] bg-[#ffffff33]">
