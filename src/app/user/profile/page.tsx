                  ...
                  <div className="lg:w-[16rem] flex lg:justify-start  mt-6 lg:mt-1">
                    <div className=" flex flex-col lg:items-start items-center gap-[0.75rem]">
                      ...
                      <div className="flex row gap-1">
                        <Link href={'https://x.com/fr_Ani5'} className="box1 right-trapezium  w-[2rem] h-[2rem] bg-[#ffffff33]">
                        ...
                        <Link href={'https://discord.gg/vASfWSV6'}  className="box1 left-right-trapezium w-[2rem] h-[2rem] px-2 bg-[#ffffff33]" >
                        ...
                        <Link href={'https://t.me/+8Cgy2Zu8y-U0MjVl'} className="box1 left-trapezium w-[2rem] h-[2rem] bg-[#ffffff33]">
