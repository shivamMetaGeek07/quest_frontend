        ...
        <nav className="bg-black text-white flex items-center space-x-16 justify-between p-4">
            ...
            <div className="hidden md:flex items-center space-x-5 w-2/6 rounded-2xl">
                <input
                    type="text"
                    placeholder="SEARCH"
                    className="bg-gray-800 text-white px-3 py-1 rounded-2xl w-full h-12"
                />
            ...
            <div className="flex items-center space-x-20 rounded-2xl w-4/6">
                <div className="bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 text-white py-2 overflow-hidden relative w-2/3 rounded-sm">
