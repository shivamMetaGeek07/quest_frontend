  ...
  return (
    <div className="lg:mx-16">
      ...
      <div className="eco&cat flex flex-col lg:flex-row gap-10 ">
        <div className="Main grid gap-4 grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 pt-6 lg:basis-[50%]">
          {data.map((item) => (
            <div key={item.id} className="card p flex gap-1">
              <div className="card bg-black w-28 h-28 border border-gray-700 flex items-center justify-center">
        ...
        <div className="grid items-center  lg:grid-cols-5 sm:grid-cols-3 gap-10 grid-cols-2 mt-16  shadow-2xl rounded-md mx-auto  basis-[50%]">
          {EcoData.map((card) => (
            <div key={card.id} className="cate flex items-center mb-4 lg:mb-0">
