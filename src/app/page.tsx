        ...
        <div className="relative flex items-center justify-center h-screen text-white">
          ...
          <div className="relative z-10 text-center max-w-3xl">
            ...
            <div className="mt-8 flex justify-center gap-4">
              <Link href="/home" className="bg-blue-600 text-white py-2 px-6 rounded-lg hover:bg-blue-700 transition duration-300" >
                   Get Onboarded
              </Link>
              <Link href="/explore" className="bg-white text-black py-2 px-6 rounded-lg hover:bg-gray-200 transition duration-300">
                Explore
              </Link>
            </div>
          </div>
