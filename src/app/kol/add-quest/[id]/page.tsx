...
function CreateQuest ()
{
  ...
  return (
    <div className="min-h-screen text-white bg-black flex flex-col items-center justify-center py-10 px-5">
      <div className="bg-gray-900 mt-10 p-10 rounded-xl shadow-xl w-full max-w-lg">
        <h1 className="text-3xl font-bold mb-6 text-center text-purple-400">Create New Quest</h1>
