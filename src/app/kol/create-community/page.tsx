      ...
      >
        <div className="relative bg-[#282828] p-4 md:p-10 shadow-xl w-full h-full rounded-lg overflow-y-auto">
          ...
          <form onSubmit={ handleSubmit }>
            ...
            {/* Ecosystem section */ }
            <div className="mb-5">
              <label className="block text-white font-semibold">Ecosystem</label>
              <select
                value={ ecosystems }
                onChange={ ( e ) => setEcosystems( e.target.value ) }
                className="w-full px-4 py-2 mt-2 border rounded-lg focus:outline
                -none focus:ring-2 focus:ring-blue-500 transition-colors duration-300
