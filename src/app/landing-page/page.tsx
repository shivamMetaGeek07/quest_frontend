  ...
  return (
    <div >
      ...
      <div className="relative z-10 text-center max-w-3xl">
        <p className="text-sm tracking-widest text-neutral-400">FAM PROTOCOL PRESENTS...</p>
        ...
        <div className="mt-8 flex justify-center gap-4">
          ...
          <button className="bg-white text-black py-2 px-6 rounded-lg hover:bg-gray-200 transition duration-300">
            Explore
          </button>
        </div>
      </div>
