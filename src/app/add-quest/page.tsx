...
import { createQuest, Reward } from '../../redux/reducer/questSlice';
import { RootState, AppDispatch } from '../../redux/store';

function CreateQuest ()
{
  const dispatch = useDispatch<AppDispatch>();
  const { loading, error } = useSelector( ( state: RootState ) => state.quests );
  ...
  const handleSubmit = async ( e: React.FormEvent ) =>
  {
    ...
    try
    {
      const resultAction = await dispatch( createQuest( newQuest ) );
